...
const bar = new Spinner('bouncingBar', { color: 'magenta' })
const dots = new Spinner('dots', { color: 'yellow' })
...
let examples = [
  ...
  () => log.start('info5', "that's okay, there is a lot to explore!", 'smiley'),
